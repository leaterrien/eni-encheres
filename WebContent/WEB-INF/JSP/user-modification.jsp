...
<form class="row" action="<%=request.getContextPath()%>/ModificationUtilisateur" method="post">
	<div class="row">
		<div class="col-md-6"><label for=username>Pseudo : </label><input class="col-md-6" type="text" pattern="^[a-zA-Z0-9]+$" maxLength="20" id="username" name="username" value="${utilisateur.pseudo}" /></div>
