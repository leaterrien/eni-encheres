...
<form action="<%=request.getContextPath()%>/ModificationUtilisateur" method="post">
	<div class="row">
		...
		<div class="col-md-6"><label for="city">Ville : </label><input class="col-md-6" type="text" maxLength="50" id="city" name="city" value="${utilisateur.ville}" required/></div>	<br/>
		<br/>
		<p class="font-weight-bold">Modification du mot de passe : </p>
	...
	<a style = "margin: 5 px" href="${pageContext.request.contextPath}/SuppressionUtilisateur" class="col-3 btn button-navigation">Supprimer mon compte</a>
	<input style = "margin: 5 px" type="submit" class="col-2 btn button-navigation" value="Enregistrer"/>
